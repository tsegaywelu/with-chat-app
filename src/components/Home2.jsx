        ...
        <ul className="grid gap-8 grid-cols-2 lg:grid-cols-3 overflow-hidden mt-14 ">
            ...
            <li className="relative bg-white flex flex-col border rounded shadow-md hover:shadow-primary-400">
              ...
              <div className="flex flex-col justify-beetween gap-3 px-4 py-2">
                ...
                {contextData.Language == "English"
              ? "TDF still in their army "
              : "አብ ሰራዊት ዘለዉ"}
             
                  </h3>
                 

                <p className="text-gray-600 two-lines">n adom elom ksab kezi ykashuhu</p>
            ...
            <li className="relative bg-white flex flex-col border rounded shadow-md hover:shadow-primary-400">
              ...
              <div className="flex flex-col justify-beetween gap-3 px-4 py-2">
                <h3 className="text-lg font-bold"> {contextData.Language == "English"
              ? "TDF wchich are in thier home "
              : "ብኽብሪ ዝተሰናበቱ"}</h3>

                <p className="text-gray-600 two-lines">bselam gezam zelewu</p>
            ...
            <li className="relative bg-white flex flex-col border rounded shadow-md hover:shadow-primary-400">
              ...
              <div className="flex flex-col justify-beetween gap-3 px-4 py-2">
                <h3 className="text-lg font-bold"> {contextData.Language == "English"
              ? "family which loose their member"
              : "ስድራ ስውአት"} </h3>

                <p className="text-gray-600 two-lines">swatna bagbabbu nkenaken</p>
