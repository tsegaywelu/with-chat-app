    ...
    <div className="max-w-screen-lg px-4 sm:px-6 text-gray-800 sm:grid md:grid-cols-4 sm:grid-cols-2 mx-auto">
        ...
        <div className="p-5">
            ...
            <a className="my-3 block" href="/#">
                <span className="text-indigo-600 text-xs p-1 hover:text-indigo-950">መቀለ፤ ዓይደር ታክሲ ፌርማታ ውርድ ኢልካ፤ ፊት
             ንፊት ንግዲ ባንኪ ኢትዮጵያ ጨንፈር ሮማናት አብ ዝርከብ ህንጻ</span></a>
                <a className="my-3 block   hover:text-indigo-950" href="/www.goldenbic.biz">
                <span className="text-teal-600 text-xs p-1">www.goldenbic.biz</span></a>
